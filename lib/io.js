...
(function() {
    ...
    sessionSockets.on('connection', function(err, socket, session) {
        ...
        // Need a mechanic for detecting user activity, updatin session with new maxAge
        socket.emit('receive session id', session);
        socket.on('update session id', function(value) {
