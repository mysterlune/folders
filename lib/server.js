...
var Server = function(options, app_config) {
    ...
    app.configure(function(){
        ...
        // warning - prefix option not supported by the 'full featured' memcached library
        ...
        app.set('session_secret', 'CatOnTheKeyboard');
        ...
        // direct connect memcached client
        var memcached = require('memcached');
        var memcached_client = new memcached( mem_pool );
        app.set('memcached_client', memcached_client);
        
        // // Check for upload_dir existence; create if it doesn't exist
        // fs.exists(app.get('upload_dir'), function(exists) {
        //     if(exists) { return; }
        //     fs.mkdir(app.get('upload_dir'), 0755, function(err) { if(err) { throw new Error(err) } });
        // });
