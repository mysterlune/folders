...
var Server = function(options, app_config) {
    ...
    app.configure(function(){
        ...
        var rest_backend = app_config.rest.host + (app_config.rest.port ? app_config.rest.port : '');
        app.set('rest_backend', app_config.rest.host + ':' + app_config.rest.port);
        app.set('publisher_frontend', app_config.publisher.host + ':' + app_config.publisher.port)
